...
--
-- Host: localhost
-- Generation Time: Oct 09, 2015 at 03:59 
...
INSERT INTO `note` (`id`, `title`, `content`, `updated`, `user_id`) VALUES
(1, 'Lập trình PHP', 'Lập trình PHP', '2015-10-08 03:00:05', 1),
(3, 'Tìm hiểu API', 'Tìm hiểu API', '2015-10-08 04:34:46', 1),
(4, 'Tìm hiểu API phần 2', 'Tìm hiểu API phần 2', '2015-10-08 04:35:10', 1),
(5, 'Note so 1', 'Note so 3 sida', '2015-10-08 10:28:27', 1),
(6, 'Note so 6', 'Note so 6 bi sida', '2015-10-08 10:31:12', 1),
(7, 'Note so 7', 'Note so 7 bi sida', '2015-10-08 10:41:13', 1);
...
INSERT INTO `task` (`id`, `name`, `level`, `status`, `updated`, `tag_id`, `list_id`) VALUES
(3, 'MY SQL', 1, 1, '2015-10-08 04:36:22', NULL, 1),
(4, 'HTML CSS', 2, 1, '2015-10-08 04:36:22', NULL, 1),
(5, 'MY SQL 2', 1, 1, '2015-10-08 04:36:26', NULL, 1),
(6, 'HTML CSS 2', 2, 1, '2015-10-08 04:36:26', NULL, 1);
...
--
ALTER TABLE `task`
  ADD CONSTRAINT `fk_task_list` FOREIGN KEY (`list_id`) REFERENCES `note` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
